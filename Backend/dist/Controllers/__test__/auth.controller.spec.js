...
describe('User authentication test suite', () => {
    ...
    test('It issues an error for wrong email', () => __awaiter(void 0, void 0, void 0, function* () {
        const req = {
            body: {
    ...
    test('It issues an eror when the password is wrong', () => __awaiter(void 0, void 0, void 0, function* () {
        let expectedUser = {
            userId: "85d9b39d-75b6-4496-a9ed-39960469606d",
            firstName: "John",
            lastName: "Doe",
